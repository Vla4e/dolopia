...
let dataObjects = {
  tomato: {
    ...
    paragraph:
      "Our tomato-based products include flavorful pasta sauces, rich ketchups, and other tomato creations, made from sun-ripened tomatoes that enhance any dish with their vibrant taste.",
  ...
  vegetable: {
    ...
    paragraph:
      "We also offer a selection of vegetable-based spreads and salads, featuring red pepper pates in four different levels of spiciness, along with vegetables preserved in olive oil, capturing the essence of Mediterranean produce.",
    imageUrl: new URL("@/assets/about/projects/vegetable-project.png", import.meta.url)
      .href,
  ...
  pasta: {
    ...
    paragraph:
      "We create a diverse range of pasta, including traditional varieties, vegan options, and seafood-infused pasta. These are produced using time-honored techniques like air-drying and bronze dies to ensure rich flavors and a perfect texture that holds sauces beautifully.",
