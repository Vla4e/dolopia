...
watch(() => props.isOverviewActive, (isActive) => { //initial expansion of component (subcategory page -> product page transition)
  if(isActive){
    cyclePhase(Forward)
  } else {
...
.serving { animation-delay: 0.2s; }
.awards { animation-delay: 0.4s; }
.vegetarian-tags { animation-delay: 0.6s; }
